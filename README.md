...
| [`nesterp`](sites/nesterp.md) | Syncflo's internal ERPNext (Frappe v16); `quick_purchase_invoice` + `nest_theme` deployed; `nest_crm_tasks` v0.0.4 fix on disk 2026-05-11 (deploy + smoke pending) |
